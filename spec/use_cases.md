...
**Reference design:** [fellows_local_db](https://github.com/social-network-health/fellows_local_db/blob/main/docs/Architecture.md).
...
**Realized flavor ([prm](https://github.com/social-network-health/prm/blob/main/docs/Architecture.md), Toolkit-Version 0.1):**
