...
Spec scaffolding (`_pna_triage.md` working triage doc + `_pna_spec_format_landscape.md` format-choice notes) retired in v0.1 after all spec-side and repo-side migrations landed. The spec is now self-contained: `PNA_Spec.md`, `axes.md`, `use_cases.md`, and the typed contracts under `spec/contracts/`.
